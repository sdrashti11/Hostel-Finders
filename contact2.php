          ...
          <div class="contact">
              ...
              <div class="add-contact">
                <div class="row">
                  <div class="span280px pull-left">
                    ...
                    <strong>Email.</strong> <a href="mailto:hostelfinders@gmail.com?subject=SweetWords &body=Please send me a copy of your new program!">hostelfinders@gmail.com</a> <br/>
                  </div>
                </div>
              </div>
            </div>
            <div class="contact-form">
              <form action="" method="POST">
                ...
                <a><button name="submit" class="button-send" type="submit">Submit</button></a>
              </form>
            </div>
          </div>
          <!-- End contact -->
