              ...
              <div class="moteam">
                 ...
                 <div class="row">
                   ...
                   <li class="span6 first">
                     <div class="row">
                       <div class="span180">
                          <div class="picimg"><img width="160" height="160" src="img/Raviraj.jpg" alt=""></div>
                       </div>
                       <br>
                       <div class="span260px">
                         <h6>Ravirajsinh Parmar</h6>
                         <span>DEVELOPER</span>
                         ...
                         <!-- <div class="socialmo">
                          ...
                          <a href="#" title=""><i class="icon-mail" aria-hidden="true"></i></a>
                   ...
                   <li class="span6">
                     <div class="row">
                       <div class="span180">
                          <div class="picimg"><img width="160" height="160" src="img/Ronak.jpg" alt=""></div>
                       </div>
                       <br>
                       <div class="span260px">
                         <h6>Ronak Ahir</h6>
                   ...
                   <li class="span6 first">
                     <div class="row">
                       <div class="span180">
                          <div class="picimg"><img width="160" height="160" src="img/gopal.jpeg" alt=""></div>
                       </div>
                       <br>
                       <div class="span260px">
                         <h6>Vrajgopal Vasani</h6>
                         <span>DEVELOPER</span>
                         <!-- <p>Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit. </p> -->
                   ...
                   <li class="span6">
                     <div class="row">
                       <div class="span180">
                          <div class="picimg"><img width="160" height="160" src="img/madhav.jpeg" alt=""></div>
                       </div>
                       <br>
                       <div class="span260px">
                         <h6> Madhav Katariya</h6>
                         <span>DEVELOPER</span>
                         <!-- <p>Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit. </p> -->
                   ...
                   <li class="span6">
                     <div class="row">
                       <div class="span180">
                          <div class="picimg"><img width="160" height="160" src="img/tilak.jpg" alt=""></div>
                       </div>
                       <br>
                       <div class="span260px">
                         <h6>Tilak Mistry</h6>
